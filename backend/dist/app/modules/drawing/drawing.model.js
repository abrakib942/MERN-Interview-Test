...
const textAnnotationSchema = new mongoose_1.default.Schema({
    text: String,
    x: Number,
    y: Number,
    color: String,
...
exports.Drawing = mongoose_1.default.model('Drawing', drawingSchema);
// Sample Data
...
exports.Drawing.create(sampleDrawing1);
exports.Drawing.create(sampleDrawing2);
